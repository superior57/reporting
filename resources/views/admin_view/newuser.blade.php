...
<head>
    ...
    <!-- Favicon-->
    <link rel="icon" href="{{url('themes/admin/favicon.ico')}}" type="image/x-icon">
...
<body class="theme-blue">
    ...
    <script src="{{url('themes/admin/js/pages/ui/modals.js')}}"></script>
    <script src="{{url('themes/admin/js/demo.js')}}"></script>
</body>

 <div class="modal fade" id="user_view" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title" id="defaultModalLabel">Regular User</h3>
            </div>
            <div class="modal-body">
                <form action="#" method="POST" action="{{ url('users') }}" id="form_user" >
                    <input type="hidden" id="userid" name="userid" value="" />
                    <input type="hidden" id="{{csrf_token()}}" name="_token" />
                    <form action="#" id="form_value">  
                        <div class="col-sm-12">
                            <div class="form-group form-float" >
                                <div class="row" style="text-align: right; margin-right: 10px;">
                                    <img id="user_avatar" name="user_avatar" src="{{asset('themes/register/img/default-avatar.png')}}" style="border-radius: 50%; border : 2px solid; width: 150px; ">    
                                </div>    
                                <div class="form-line focused" style="margin-bottom: 20px; margin-top: -70px; width: 150px;">
                                    <input type="text" id="user_name" name="user_name" class="form-control" value="">
                                    <label class="form-label">Username</label>
                                </div>
                                <div class="form-line focused" style="margin-bottom: 20px; width: 300px;">
                                    <input type="text" id="user_regid" name="user_regid" class="form-control">
                                    <label class="form-label">Registration ID #</label>
                                </div> 
                                <div class="form-line focused" style="margin-bottom: 20px;">
                                    <input type="text" id="user_email" name="user_email" class="form-control">
                                    <label class="form-label">Email Address</label>
                                </div>
                                <div class="form-line focused" style="margin-bottom: 20px;">
                                    <input type="text" id="user_country" name="user_country" class="form-control" value="">
                                ...
                                <div class="form-line focused" style="margin-bottom: 20px;">
                                    <input type="text" id="user_discordid" name="user_discordid" class="form-control">
                                    <label class="form-label">Discord ID</label>
                                </div>
                                <div class="form-line focused" style="margin-bottom: 20px;">
                                    <input type="text" id="user_steam" name="user_steam" class="form-control">
                                    <label class="form-label">Steam Hex Key</label>
                                </div>
                                <div class="form-line focused" style="margin-bottom: 20px;">
                                    <input type="text" id="user_five" name="user_five" class="form-control">
                                    <label class="form-label">Five M User</label>
                                </div>
                                <div class="form-line focused" style="margin-bottom: 20px;">
                                    <input type="text" id="user_curserver" name="user_curserver" class="form-control">
                                    <label class="form-label">Current Server</label>
                                </div>
                            </div>
                        </div>                       
                    </form>
            ...
            <div class="modal-footer">
                <!-- <button type="button" class="btn btn-link waves-effect">APPROVE</button> -->
 ...
 <div class="modal fade" id="server_view" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title" id="defaultModalLabel">Server Admin</h3>
            </div>
            <div class="modal-body">
                <form action="#" method="POST" action="{{ url('users') }}" id="form_user" >
                    ...
                    <form action="#" id="form_value">  
                        <div class="col-sm-12">
                            <div class="form-group form-float" >
                                <div class="row" style="text-align: right; margin-right: 10px;">
                                    <img id="server_avatar" name="server_avatar" src="{{asset('themes/register/img/default-avatar.png')}}" style="border-radius: 50%; border : 2px solid; width: 150px; ">    
                                </div>    
                                <div class="form-line focused" style="margin-bottom: 20px; margin-top: -70px; width: 150px;">
                                    <input type="text" id="server_uname" name="server_uname" class="form-control" value="">
                                    <label class="form-label">Name</label>
                                </div>
                                <div class="form-line focused" style="margin-bottom: 20px; width: 300px;">
                                    <input type="text" id="server_fname" name="server_fname" class="form-control">
                                    <label class="form-label">Admin First Name</label>
                                </div>
                                <div class="form-line focused" style="margin-bottom: 20px;">
                                    <input type="text" id="server_lname" name="server_lname" class="form-control">
                                    <label class="form-label">Admin Last Name</label>
                                </div> 
                                <div class="form-line focused" style="margin-bottom: 20px;">
                                    <input type="text" id="server_id" name="server_id" class="form-control">
                                ...
                                <div class="form-line focused" style="margin-bottom: 20px;">
                                    <input type="text" id="server_email" name="server_email" class="form-control">
                                    <label class="form-label">Admin Email Address</label>
                                </div>
                                <div class="form-line focused" style="margin-bottom: 20px;">
                                    <input type="text" id="server_country" name="server_country" class="form-control" value="">
                                    <label class="form-label">Country</label>
                                </div>
                                <div class="form-line focused" style="margin-bottom: 20px;">
                                    <input type="text" id="server_userid" name="server_userid" class="form-control">
                                    <label class="form-label">#Of User In Server</label>
                                </div>
                                <div class="form-line focused" style="margin-bottom: 20px;">
                                    <input type="text" id="server_adminid" name="user_regid" class="form-control">
                                    <label class="form-label">#Of Admin</label>
                                </div>
                                <div class="form-line focused" style="margin-bottom: 20px;">
                                    <input type="text" id="server_discordlink" name="server_discordlink" class="form-control">
                                    <label class="form-label">Discord Link</label>
                                </div>
                                <div class="form-line focused" style="margin-bottom: 20px;">
                                    <input type="text" id="server_sitelink" name="server_sitelink" class="form-control">
                  ...
                  success: function(users)
                  {
                     //if success reload ajax table
                        ...
                        for ( var i = 0; i < users.length; i ++ ){
                            ...
                            row += "<td>"+no+"</td><td>"+users[i]['name']+"</td><td>"+users[i]['reg_id']+"</td><td>"+users[i]['email']+"</td><td>"+users[i]['authority']+"</td><td><button value='"+users[i]['id']+"' class='btn btn-sm btn-default' onclick='view_user(this)' ><i class='glyphicon glyphicon-eye'>View</i></button></td><td><button value='"+users[i]['id']+"' class='btn btn-sm btn-default' onclick='approve_user(this)' ><i class='glyphicon glyphicon-ok'>Approve</i></button></td><td><button value='"+users[i]['id']+"' id=''  onclick='delete_user(this)' class='btn btn-sm btn-default'><i class='glyphicon glyphicon-trash'>DisApprove</i></button></td>"
                            row += "</tr>";
                            data += row;
                        }
        ...
        $.ajaxSetup({
         ...
         $.ajax({
              ...
              success: function(users)
              {
                ...
                text = "Successed to Approved one user";
                table_reload();
             ...
             error: function (jqXHR, textStatus, errorThrown)
             {
                text = "Failed to approve one user!"        
                showNotification(colorName, text, placementFrom, placementAlign, animateEnter, animateExit); 
            }
    });        
    }

    function view_user(element)
    {
        // console.log("123");
        var id = $(element).attr('value');
        $('#id').val(id);
        ...
        success: function(data)
        {
               ...
               if (data[0]['authority'] == 'RegularUser') {
                  ...
                  $('#user_discordid').val(data[0]['dis']);
                  $('#user_curserver').val(data[0]['cur_serverid']);
                  $('#user_country').val(data[0]['country_code']);

                  var ava = data[0]['avatar'];

                  if (ava == "")
                    $('#user_avatar').attr('src', "{{ asset('themes/register/img/default-avatar.png') }}");
                  else
                    $('#user_avatar').attr('src', "{{ asset('themes/img/users') }}" +"/"+ data[0]['avatar']);
                  $('#user_view').modal('show');
               }
               else if (data[0]['authority'] == 'ServerAdmin')
               {
                  $('#serverid').val(data[0]['id']);
                  $('#server_uname').val(data[0]['name']);
                  $('#server_fname').val(data[0]['admin_fname']);
                  $('#server_lname').val(data[0]['admin_lname']);
                  $('#server_id').val(data[0]['server_id']);
                  $('#server_name').val(data[0]['server_name']);
                  $('#server_email').val(data[0]['email']);
                  $('#server_country').val(data[0]['country_code']);
                  $('#server_userid').val(data[0]['server_userid']);
                  $('#server_adminid').val(data[0]['adminid']);
                  $('#server_discordlink').val(data[0]['dis_link']);
                  $('#server_sitelink').val(data[0]['website_link']);

                  var ava = data[0]['avatar'];

                  if (ava == "")
                    $('#server_avatar').attr('src', "{{ asset('themes/register/img/default-avatar.png') }}");
                  else
                    $('#server_avatar').attr('src', "{{ asset('themes/img/users') }}" +"/"+ data[0]['avatar']);
                  $('#server_view').modal('show');
               }
    ...
    function delete_user(element)
    {
     ...
     $.ajax({
      ...
      success: function(data)
      {
               ...
               //if success reload ajax table
               table_reload();
               text = "Successed to DisApproved one user!"
               showNotification(colorName, text, placementFrom, placementAlign, animateEnter, animateExit);
