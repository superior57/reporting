...
<head>
    ...
    <title>Welcome To | ADMINISTRATOR - CONTROL PANEL</title>
    <!-- Favicon-->
...
<body class="theme-blue">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <!-- #END# Tasks -->
                    <li class="pull-right"><a href="javascript:void(0);" class="js-right-sidebar" data-close="true"><i class="material-icons" hidden>more_vert</i></a></li>
                </ul>
            </div>
        </div>
    </nav>
            ...
            <div class="menu">
                <ul class="list">
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="{{ url('admin445/userlist') }}">User List</a>
                            </li>
                            <li>
    ...
    <script src="themes/admin/js/pages/index.js"></script>
